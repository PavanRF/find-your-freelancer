...
const Index = () => {
  return (
    <div className="min-h-screen bg-background text-foreground landing-bg flex flex-col">
      <header className="p-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <Truck className="h-8 w-8 text-primary" />
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Fast Truck</h1>
        </div>
        <div className="flex items-center gap-3">
          <ThemeToggle />
          <Link to="/auth">
            <Button variant="default" className="font-bold shadow-lg shadow-primary/20 transition-all hover:scale-105">
              Login / Sign Up
            </Button>
          </Link>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        <div className="max-w-3xl space-y-8 animate-fade-in">
          ...
          <div className="flex gap-4 justify-center pt-8">
            <Link to="/auth">
              <Button size="lg" className="text-lg px-8 py-6 h-auto shadow-xl shadow-primary/20 transition-all hover:scale-105">
                Get Started
              </Button>
            </Link>
            <Button size="lg" variant="outline" className="border-border bg-card/50 text-foreground hover:bg-accent text-lg px-8 py-6 h-auto backdrop-blur-sm">
              Learn More
            </Button>
          </div>
        </div>
      ...
      <footer className="p-6 text-center text-muted-foreground mt-12">
